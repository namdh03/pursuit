                                ...
                                <div class="col l-6 m-6 c-6">
                                    ...
                                    <div class="checkout__address">
                                        <c:choose>
                                            ...
                                            <c:otherwise>
                                                <div
                                                    class="user__addresses-content"
                                                >
                                                    <div
                                                        class="user__address-empty"
                                                    >
                                                        <img
                                        ...
                                        <div class="checkout__address-popup">
                                            <div
                                                class="checkout__address-inner"
                                            >
                                                <div
                                                    class="checkout__address-top"
                                                >
                                                    <p
                                                ...
                                                <div
                                                    class="checkout__address-bottom"
                                                >
                                                    <p
                                                        class="cart__separate"
                                                    ></p>
                                        ...
                                        <div class="user__address-popup">
                                            <div
                                                class="user__address-popup-inner"
                                            >
                                                <p
                                ...
                                <div class="col l-6 m-6 c-6">
                                    <section class="cart__summary">
                                        ...
                                        <ul class="cart__summary-list">
                                            ...
                                            >
                                                <p
                                                    class="cart__summary-item-key"
                                                >
                                                    Original Price
                                                </p>
                                                <p
                                                    class="cart__summary-item-value"
                                                >
                                                    $${formattedTotal}
                                                </p>
                                            </li>
