...
public class SizeController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String colorId = request.getParameter("code");
        Gson gson = new Gson();
        List<ProductVariantDTO> list = null;
        
        try {
            ProductVariantDAO pvdao = new ProductVariantDAO();
            list = pvdao.getPVByColorID(productId, colorId);
        } catch (Exception e) {
            log("Error at SizeController: " + e.toString());
        } finally {
